...
public class Rabbit extends Hitable implements Drawable {
    ...
    public void draw(Graphics2D g2d) {
        ...
        g2d.drawString(Integer.toString(score.number), this.x + (int) this.w / 2, (int) (this.y - rabbitNumberDeltaY));
    }
    ...
    void die() {
        this.y = 0;
        this.x = new Random().nextInt(rabbitRespawnBound);
        this.vy = 0;
    }
